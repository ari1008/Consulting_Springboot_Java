...
public class FilterBuilderService {
     ...
     */
    public List<FilterCondition> createFilterCondition(String criteria) throws Exception {
     ...
     * @return PageRequest
     */
    public PageRequest getPageable(int size, int page, String order) throws Exception {
